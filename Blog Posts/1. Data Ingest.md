# Blog Post 1 - Data ingest example with Upload feature in Kibana
...
This had us jotting down the feeding times for our little one which consisted of a `start time`, `end time`, calculate the `duration` and lastly the 
...
2. Navigate to Kibana's home page and click on Upload File
